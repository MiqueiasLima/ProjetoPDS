...
public class DaoJogador implements Dao {
    ...
    public DaoJogador(){
       this.pool=new ConnectionPool("jdbc:mysql://localhost:3306/mydb", "root", "SuaSenha", "com.mysql.jdbc.Driver");
    }
       ...
       this.conexao= this.pool.getConnection();
        try {
           ...
           //      nome=?,dataNascimento=?,posicao=?,melhorPe=?,time_id=?
                ...
                jogador.setMelhor_pe(this.conexao.getRs().getString("posicao").charAt(0));
                Time time = new Time ();
